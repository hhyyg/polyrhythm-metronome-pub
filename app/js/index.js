...
const bpmControl = document.querySelector('#bpm-control') ?? throwError('not found #bpm-control');
bpmControl.addEventListener(MyNumberControlHTMLElement.EventName_ValueChanged, onChangeInputControl);
const divisionRightControl = document.querySelector('#division-right-control') ?? throwError('not found #division-right-control');
const divisionLeftControl = document.querySelector('#division-left-control') ?? throwError('not found #division-left-control');
...
const leftSketch = new window.p5(sketchLeft, document.getElementById('canvas-left'));
leftSketch.conductor = conductor;
const rightSketch = new window.p5(sketchRight, document.getElementById('canvas-right'));
